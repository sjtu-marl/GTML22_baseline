...
@status: passed
@author: thu-ml, Ming Zhou
@reference: https://github.com/thu-ml/tianshou/blob/master/tianshou/utils/net/discrete.py
"""
...
from common.data import Batch, to_torch
from common.models.torch.net import MLP
